...
<body>
        ...
        <div class="container">
            <div class="wrapper">
				...
				<br/><br/><br/><br/><br/>
					<?php echo form_open_multipart("rencai/setmyinfo"); ?>					
					<div class="job-detail validator-v5">
					    <p class="title">填写个人信息</p>
						<p>
							<span class="job-item-key ver-top"><em class="star">*</em>我在干嘛？:</span>
							<span>
								<select name="state" type="select" class="select-btn">
									<option value="0" selected>寻找实习</option>
									<!--option value="1">寻找人才</option-->
								</select>
							</span>
						</p>
						<p>
						   <span class="job-item-key ver-top"><em class="star">*</em>谋求职位:</span>
